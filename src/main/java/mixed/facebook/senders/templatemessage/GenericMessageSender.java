...
public class GenericMessageSender {
    ...
    public void sendGenericMusicParserMessage(String recipientId, String message) throws MessengerApiException, MessengerIOException, IOException {
        ...
        if (!songs.isEmpty()) {
            ...
            elements.add(
                    Element.create(songs.get(0).getName(), of("Enjoy your favorite song lyrics"), of(new URL("http://www.geekersmagazine.com/wp-content/uploads/2013/01/Music-Notes-free-song-lyrics.jpg")), empty(), of(riftButtons)));
